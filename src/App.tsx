...
function SortableItem({ cfg, currentConfig, apply, selectConfig, duplicate, del }: SortableItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="config-icon"><FactoryIconSmall /></div>
